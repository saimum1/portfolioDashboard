    ...
    >
        ...
        <div style={{backgroundColor:'' ,width:'100%' ,height:'100%',display:'flex' ,justifyContent:'center',
            ...
            width:'100%',gap:'11px' }}>
                ...
                className="py-4 mb-1 border-none rounded-[8px] bg-[#27CF7A] mt-1 font-inter w-full px-4 font-bold" style={{height:'48px',display:'flex',justifyContent:'center' ,alignItems:'center' ,fontStyle:'normal',fontFamily:'inter',color:'#FFF'}}><a href='/signing'>Back to login</a></button>
            </div>
        ...
        <div style={{backgroundColor:'' ,width:'100%' ,height:'100%',display:'flex' ,justifyContent:'center',
            ...
            width:'100%',gap:'11px' }}>
                ...
                <TextInput type='password' className=" border-none rounded-[10px] bg-[#444444]" style={{height:'48px',fontFamily:'inter',width:'100%',color:'rgba(255, 255, 255, 0.85)'}} placeholder="new password here"/>
            ...
            width:'100%',gap:'11px' }}>
                ...
                <TextInput type='password' className=" border-none rounded-[10px] bg-[#444444]" style={{height:'48px',fontFamily:'inter',width:'100%',color:'rgba(255, 255, 255, 0.85)'}} placeholder="confirm password"/>
            </div>
            ...
            width:'100%',gap:'11px' }}>
                ...
                className="py-4 mb-1 border-none rounded-[8px] bg-[#27CF7A] mt-1 font-inter w-full px-4 font-bold" style={{height:'48px',display:'flex',justifyContent:'center' ,alignItems:'center' ,fontStyle:'normal',fontFamily:'inter',color:'#FFF'}} onClick={()=>setpasschangedstatus(true)}>Reset password</button>
            </div>
